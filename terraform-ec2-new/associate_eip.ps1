...
$instanceId = "i-099c35ed8bc5b9108"  # Reemplazar con el ID de tu instancia EC2
$allocationId = "eipalloc-0bee0b0ecf4e37d7a"  # Reemplazar con el ID de asignación de la IP elástica
